...
//aita admin je je api data dekhte parbe sekhane bosabo
//jate admin cara onno kew hole na dhukte pare
//use verify admin after VerifyToken (middle ware proccess a kora)
...
//patch for update item
   app.patch('/menu/:id', async(req, res) =>{
    ...
    //checking isAdmin ? if user have user role : admin
  app.get('/users/admin/:email',verifyToken, async(req, res)=>{
   ...
   app.patch('/users/admin/:id',verifyAdmin,verifyToken, async(req, res)=>{
    ...
    //payment get for showing payment history
